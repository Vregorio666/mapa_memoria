...
function openPanel(content1, content2, content3, content4) {
    ...
    document.querySelector('.tab-btn[data-tab="page1"]').classList.add('active');
      document.querySelector('.tab-btn[data-tab="page2"]').style.display = content2 ? 'block' : 'none';
    document.querySelector('.tab-btn[data-tab="page3"]').style.display = content3 ? 'block' : 'none';

    setTimeout(() => initGalerias(), 50);
}
...
function openLibroPDF(page = 1) {
    ...
    pdfWindow.innerHTML = `
        <button onclick="closePDFOverlay('pdf-overlay-libro')" style="
            ...
            z-index: 10;
        ">✕</button>
        <iframe src="./libros/libro_cm/libro.pdf#page=${page}&zoom=page-width&toolbar=1" style="
            width: 100%;
            height: 100%;
            border: none;
            border-radius: 10px;
...
function openRutaPDF(page = 1) {
    ...
    pdfWindow.innerHTML = `
        <button onclick="closePDFOverlay('pdf-overlay-ruta_memoria')" style="
            ...
            z-index: 10;
        ">✕</button>
        <iframe src="./libros/ruta/ruta_memoria.pdf#page=${page}&zoom=85-width&toolbar=1" style="
            width: 100%;
            height: 100%;
            border: none;
            border-radius: 10px;
...
document.getElementById('slider-anio').addEventListener('input', function() {
    ...
    if (anioSeleccionado === anioActual) {
        document.getElementById('slider-label').innerHTML = 'Hoy';
    } else if (anioSeleccionado === 1972) {
        document.getElementById('slider-label').innerHTML = '10 Sep 1973';  // ← etiqueta especial para el mínimo
    } else {
        document.getElementById('slider-label').innerHTML = anioSeleccionado;
    }
...
function renderFoto() {
        overlay.innerHTML = `
            ...
            <button id="btn-prev" style="
                ...
                opacity: ${indice === 0 ? 0.2 : 1};
                pointer-events: ${indice === 0 ? 'none' : 'auto'};">‹</button>
            <img src="${fotos[indice]}" style="
                max-width: 85%;
                max-height: 85vh;
                border-radius: 8px;
                box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
            <button id="btn-next" style="
                ...
                background: none; border: none; color: white;
                font-size: 48px; cursor: pointer;
                opacity: ${indice === fotos.length - 1 ? 0.2 : 1};
                pointer-events: ${indice === fotos.length - 1 ? 'none' : 'auto'};">›</button>
            <div style="
                position: absolute; bottom: 20px; color: white;
                font-family: Arial; font-size: 14px; opacity: 0.7;">
                ${indice + 1} / ${fotos.length}
            </div>
        `;
        overlay.querySelector('#btn-prev').onclick = () => { indice--; renderFoto(); };
        overlay.querySelector('#btn-next').onclick = () => { indice++; renderFoto(); };
    }
...
function initGalerias() {
    document.querySelectorAll('.galeria').forEach(function(galeria) {
        ...
        if (galeria.closest('.galeria-contenedor')) return; // evitar duplicados
        ...
        // Wrapper horizontal (flechas + galería)
        ...
        function actualizar() {
            ...
            imgs[indice].classList.add('activa');
            contador.innerHTML = `${indice + 1} / ${imgs.length}`;
            prev.style.opacity = indice === 0 ? 0.3 : 1;
            next.style.opacity = indice === imgs.length - 1 ? 0.3 : 1;
            descripcion.innerHTML = imgs[indice].dataset.descripcion || '';
            imgs[indice].style.objectPosition = imgs[indice].dataset.position || '';
        }
        ...
        imgs.forEach(function(img) {
            img.onclick = function() { ampliarFoto(img.src, galeria); };
        });

        // Estructura: contenedor > wrapper > (prev + galeria + next) + descripcion
        ...
        contenedor.appendChild(descripcion); // ← abajo del wrapper, dentro del contenedor
        actualizar();
    });
}
...
var marker = L.marker([-39.817309, -73.246849], {icon: ejecucion});
marker.anio = 1981;
marker.anioMemorial = 2006;
marker.on('click', function() {
    ...
    openPanel(
        `<h3><a href="https://memoriaviva.com/nuevaweb/centros-de-detencion/x-region/recinto-cni-en-calle-perez-rosales-no-764-valdivia/" target="_blank">Recinto CNI Valdivia / Hoy Casa de la Memoria</a></h3>
                <div class="galeria">
     <img src="./Galerias/casa_memoria/fcm_1.png" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./Galerias/casa_memoria/fcm_2.png" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./Galerias/casa_memoria/fcm_3.png" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./Galerias/casa_memoria/fcm_5.png" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
        ...
        <div style="display: flex; justify-content: space-around; gap: 20px; margin-top: 30px;">
            ...
            <div style="text-align: center; cursor: pointer; flex: 1;" onclick="openRutaPDF(10)">
                <img src="./libros/ruta/portada_ruta.jpg" alt="Portada Ruta de la Memoria"
        ...
        `<h3>Registro Audiovisual</h3><br>
            ...
            <iframe width="40%" height="100%" style="max-width: 500px; border: 3px solid #1b2734; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" src="https://www.youtube.com/embed/TobTr6ehhMw" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <iframe width="40%" height="100%" style="max-width: 800px; border: 3px solid #1b2734; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" src="https://www.youtube.com/embed/DU-OxsAvABk" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <iframe width="40%" height="100%" style="max-width: 800px; border: 3px solid #1b2734; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" src="https://www.youtube.com/embed/SE_d2a7kFwg" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <iframe width="40%" height="100%" style="max-width: 800px; border: 3px solid #1b2734; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" src="https://www.youtube.com/embed/gKymlZGmyxY" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <iframe width="40%" height="100%" style="max-width: 800px; border: 3px solid #1b2734; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" src="https://www.youtube.com/embed/7CdY9wQLYuE" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <iframe width="40%" height="100%" style="max-width: 800px; border: 3px solid #1b2734; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" src="https://www.youtube.com/embed/dYIK14S_vHI" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <iframe width="40%" height="100%" style="max-width: 800px; border: 3px solid #1b2734; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" src="https://www.youtube.com/embed/snoS7-Btu28" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>      
             <div style="text-align:center; margin: 20px 0;"><iframe width="80%" height="315"  style="max-width: 800px; margin-left: 10px;  border: 3px solid #1b2734; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" src="https://www.youtube.com/embed/G6yOp5Kl-Oo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
            `,
...
var marker = L.marker([-39.832340, -73.201687], {icon: ejecucion});
marker.anio = 1973;
marker.on('click', function() {
    setAnio('25 de Octubre y 8 de Noviembre de 1973');
    openPanel(
...
militancia política: <br><br>
        ...
        <a href="https://www.memoriaviva.com/ejecutados-politicos/inostroza-nanco-jose-victor" target="_blank">Victor Inostroza Ñancos</a>, 22 años"</p>
...
var marker = L.marker([-39.82898931783156, -73.22762137804432], {icon: CCDD});
marker.anio = 1973;
marker.anioMemorial = 2023;
marker.on('click', function() {
    setAnio('1973');
    openPanel(
...
// Memorial Llancahue
var marker = L.marker([-39.848117, -73.197300], {icon: ejecucion});
marker.anio = 1973;
marker.anioMemorial = 2017;
marker.iconoInicial = ejecucion;
marker.on('click', function() {
    setAnio('1973');
    openPanel(
        `<h3>Memorial de Llancahue</h3>
                <div class="galeria">
                    <img src="./galerias/memoriales/llancahue/barria_ordonez_pedro_purisimo.webp"data-descripcion="Pedro Purisimo Barria Ordoñez<br>
                    22 años, estudiante." onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    ...
    <img src="./galerias/memoriales/llancahue/luis_hernan_pezo_jara.webp" data-descripcion="Luis Gernán Pezo Jar a<br>29 años, Obrero Maderero." onclick="ampliarFoto(this.src, this.closest('.galeria'))">
...
les habría acusado de varios delitos, entre ellos, el asalto al Retén de Neltume." "</p>
        ...
        <div style="display: flex; justify-content: space-around; gap: 20px; margin-top: 20px;">
            ...
            <div style="text-align: center; cursor: pointer; flex: 1;" onclick="openRutaPDF(12)">
                <img src="./libros/ruta/portada_ruta.jpg" alt="Portada Ruta de la Memoria" style="width: 100%; max-width: 160px; border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); transition: all 0.2s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
            </div>
        </div>`
    );
});
...
var marker = L.marker([-39.837134, -73.239760], {icon: ejecucion});
marker.anio = 1973;
marker.iconoInicial = ejecucion;
marker.on('click', function() {
    setAnio('1973');
...
marker.on('click', function() {
    ...
    openPanel(
        ...
        <p>
                <div style="text-align: center; cursor: pointer; flex: 1;" onclick="openRutaPDF(13)">
            <img src="./libros/ruta/portada_ruta.jpg" alt="Portada Ruta de la Memoria"
                 style="width: 100%; max-width: 160px; border: 2px solid #ddd; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); transition: all 0.2s;"
                 onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
        </div></p>`,
...
var marker = L.marker([-39.843286, -73.292629], {icon: ejecucion});
marker.anio = 1984;
marker.anioMemorial = 2007;
marker.iconoInicial = ejecucion;
marker.on('click', function() {
    setAnio('1984');
    openPanel(
...
// Memorial de la Mano
var marker = L.marker([-39.840809, -73.215964], {icon: ejecucion});
marker.anio = 1984;
marker.anioMemorial = 2007;
marker.iconoInicial = ejecucion;
marker.on('click', function() {
...
var marker = L.marker([-39.64158180366318, -72.33180351941546], {icon: CCDD});
marker.anio = 1973;
marker.anioMemorial = 2016;
...
// Tenencia Pirihueico
var marker = L.marker([-40.025581, -71.721359], {icon: ejecucion});
marker.anio = 1973;
marker.on('click', function() {
    setAnio('1973');
    openPanel(
...
// Memorial Liquiñe
var marker = L.marker([-39.746590, -71.852240], {icon: ejecucion});
marker.anio = 1995;
marker.anioMemorial = 1995;
marker.on('click', function() {
    setAnio('1995');
    openPanel(
    ...
    <img src="./galerias/memoriales/liquine/sin_foto.webp" data-descripcion="José Héctor Bórquez Levicán <br>, 30 años, obrero maderero, Jefe de faenas del fundo Trafún, miembro del MCR, detenido en Trafún" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    ...
    <img src="./galerias/memoriales/liquine/sin_foto.webp"data-descripcion="Carlos Alberto Cayumán Cayumán <br> 21 años, obrero maderero, vinculado al MCR, detenido en Trafún." onclick=" ampliarFoto(this.src, this.closest('.galeria'))">
    ...
    <img src="./galerias/memoriales/liquine/fuentealba_caldern_isaas_jos.webp" data-descripcion="Isaías José Fuentealba Calderón<br> 29 años, Jefe de aárea deñ COFOMAP en el fundo Trafún, miembro del MCR.<br> Fue detenido en Liquiñe, cuando se dirigía a su domicilio" onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./galerias/memoriales/liquine/sin_foto.webp" data-descripcion="Luis Armando Lagos Torres <br> 50 años, obrero maderero del COFOMAP, militante del Partido Socialista, detenido en Carranco" data-descripcion="Rudemir Saavedra Bahamodes, 29 años, Obrero Maderero." onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./galerias/memoriales/liquine/sin_foto.webp" data-descripcion="Alberto Segundo Reinante Raipá n<br> 29 años, obrero maderero del COFOMAP, miembro del MCR, detenido en Trafún."onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    ...
    <img src="./galerias/memoriales/liquine/reinante_modesto.webp" data-descripcion="Modesto Juan Reinante Raipán <br>18 años, oberero maderero del COFOMAP, miembro del MCR, detenido en Trafún"onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./galerias/memoriales/liquine/sin_foto.webp" data-descripcion="Luis Alfredo Rivera Catricheo <br> cuya identidad se acreditó por medio de tesitgos, 54 años, obrero maderero del COFOMAP, sin militancia politica, detenido en Paimún"onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./galerias/memoriales/liquine/sin_foto.webp" data-descripcion="Alejandro Antonio Tracanao Pincheira< br> 22 años, obrero maderero del COFOMAP, vinculado al MCR, detenido en Trafún"onclick="ampliarFoto(this.src, this.closest('.galeria'))">
    <img src="./galerias/memoriales/liquine/sin_foto.webp" data-descripcion="Miguel José Tracanao Pincheira <br> 25 años, obrero maderero del COFOMAP, vinculado al MCR, detenido en Trafún"onclick="ampliarFoto(this.src, this.closest('.galeria'))">
...
<p>"El 10 de octubre de 1973, entre las 21:00 y las 23:00 horas, fueron detenidas en el
...
<br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/borquez-levican-jose-hector" target="_blank">José Héctor Bórquez Levicán</a>
...
<br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/curinanco-reyes-mauricio-segundo" target="_blank">Mauricio Segundo Curiñanco Reyes</a>, 38 años
...
<br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/reinante-raipan-alberto-segundo" target="_blank">Alberto Segundo Reinante Raipán</a>, 39 años
...
<br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/reinante-raipan-modesto-juan" target="_blank">Modesto Juan Reinante Raipán</a>, 18 años
<br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/rivera-catricheo-luis-alfredo" target="_blank">Luis Alfredo Rivera Catricheo</a>, 54 años
...
<br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/tracanao-pincheira-eliseo-maximiliano" target="_blank">Eliseo Maximiliano Tracanao Valenzuela </a>, 18 años
<br><br>


Se ha podido acreditar que las detenciones fueron practicadas por personal
...
// Caso Molco
var marker = L.marker([-39.823737, -72.082169], {icon: ejecucion});
marker.anio = 1973;
marker.on('click', function() {
    setAnio('1973');
    openPanel(
...
<br><a href="https://www.memoriaviva.com/ejecutados-politicos/superby-jeldres-mario-edmundo" target="_blank">Mario Edmundo Superby Jeldres</a>
...
<p style="font-style: italic; text-align: right;"> Informe Rettig p 398</p><br>"</p>`,
        `<h3>Registros</h3>`, `<h3>Testimonios</h3>`, `<h3>Expedientes</h3>`
    );
});
...
marker.on('click', function() {
    ...
    openPanel(
        ...
        <p>La noche del 9 de Octubre de 1973  la casa de administración del fundo Chihuio, de propiedad de Américo González, 
...
// Memorial Chihuio
var marker = L.marker([-40.231556, -71.970582], {icon: ejecucion});
marker.anio = 1973;
marker.anioMemorial = 1994;
marker.iconoInicial = ejecucion;
marker.on('click', function() {
    setAnio('1998');
    openPanel(
...
// Siscahue
var marker = L.marker([-40.205396, -72.103042], {icon: ejecucion});
marker.anio = 1973;
marker.on('click', function() {
...
<br>        
<br> <a href="https://www.memoriaviva.com/detenidos-desaparecidos/ancacura-manquian-cardenio" target="_blank">Cardenio Ancacura Maquian</a> campesino, militante socialista;
<br>
...
<br>
<br> <a href="https://www.memoriaviva.com/detenidos-desaparecidos/gonzalez-calfulef-teofilo-zaragozo" target="_blank">Manuel Hernandez Inostroza</a>, 42 años, sastre, ex candidato a Regidor por Lago Ranco y militante del Partido Socialista;
<br>
<br> <a href="https://www.memoriaviva.com/detenidos-desaparecidos/gonzalez-calfulef-teofilo-zaragozo" target="_blank">Arturo Vega Gonzalez</a>, 20 años, obrero panificador, también socialista.
<br><br>
...
// Puente Nilahue
var marker = L.marker([-40.285166, -72.171522], {icon: ejecucion});
marker.anio = 1973;
...
marker.iconoInicial = ejecucion;
marker.on('click', function() {
    setAnio('19 de Septiembre de 1973');
    openPanel(
...
<br><br>
<a href="https://memoriaviva.com/ejecutados-politicos/santana-alarcon-raul" target= "_blank">Raúl Santana Alarcón</a>, 29 años, auxiliar de la Universidad de Chile, sede
Osorno; Dirigente vecinal, Presidente del Comité de pobladores sin casa y militante del Partido Socialista.
<br><br>
<a href="https://memoriaviva.com/detenidos-desaparecidos/vidal-panguilef-jose" target= "_blank">José Mateo Vidal Panguilef</a>, 26 años, obrero, militante socialista.
<br><br>El día 16 de septiembre de 1973 por un Bando emitido por radio se llamó a
presentarse a ambos ante las nuevas autoridades.  Al día siguiente, horas después
de que fueran allanados sus domicilios, decidieron presentarse y, en compañía de
la cónyuge de Santana, se dirigieron al domicilio de un oficial de la Tercera
Comisaría de Rahue, Osorno.  Este los dejó en su casa de calle Manuel
Rodríguez, de la ciudad de Osorno.  Desde allí fueron trasladados a la Tercera
Comisaría de Rahue, donde fueron vistos por testigos entre el 17 y 19 de
septiembre de 1973.  El día 19 fueron sacados de dicha unidad policial y
conducidos al puente sobre el Río Pilmaiquén, lugar donde se les dio muerte
mediante disparos que carabineros les hicieron, tras hacerlos correr.  Los cuerpos
de Santana y Vidal fueron encontrados en el mes de enero de 1974 en el Río
Pilmaiquén.</p>
<p style="font-style: italic; text-align: right;">Informe Rettig p 403</p>
...
var marker = L.marker([-39.686294, -73.101902], {icon: ejecucion});
marker.anio =  1973;
marker.anioMemorial = 1994;
marker.iconoInicial = ejecucion;
marker.on('click', function() {
    setAnio('12 de Octubre de 1973');
    openPanel(
...
var marker = L.marker([-39.2748409, -72.2310227], {icon: ejecucion});
marker.anio = 1973;
marker.anioMemorial = 2008;
marker.iconoInicial = ejecucion;
marker.on('click', function() {
    setAnio('1973');
    openPanel(
...
<br>   <a href="https://memoriaviva.com/detenidos-desaparecidos/alamos-rubilar-salvador" target="_blank">Salvador Alamos Rubilar</a>, 45 años, industrial, militante del Partido Socialista, detenido en Liquiñe
<br> <br>   <a href="https://memoriaviva.com/detenidos-desaparecidos/borquez-levican-jose-hector" target="_blank">José Héctor Bórquez Levicán</a>, 30 años, obrero maderero, Jefe de faenas del fundo Trafún, miembro del MCR, detenido en Trafún
<br> <br>   <a href="https://memoriaviva.com/detenidos-desaparecidos/castro-lopez-daniel-antonio" target="_blank">Daniel Antonio Castro López</a>, 68 años, comerciante, militante del Partido Socialista, detenido en Liquiñe
<br> <br>   <a href="https://memoriaviva.com/detenidos-desaparecidos/cayuman-cayuman-carlos-alberto" target="_blank">Carlos Alberto Cayumán Cayumán</a>, 31 años, obrero maderero, vinculado al MCR, detenido en Trafún.
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/curinanco-reyes-mauricio-segundo" target="_blank">Mauricio Segundo Curiñanco Reyes</a>, 38 años, artesano carpintero, militante del Partido Socialista, detenido en Liquiñe
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/figueroa-zapata-carlos-segundo" target="_blank">Carlos Segundo Figueroa Zapata</a>, 46 años, obrero maderero, consejero del Sindicato Campesino Esperanza del Obrero del COFOMAP, militante del Partido Socialista, detenido en Paimún
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/fuentealba-calderon-isaias-jose" target="_blank">Isaías José Fuentealba Calderón</a>, 29 años, Jefe de aárea deñ COFOMAP en el fundo Trafún, miembro del MCR. Fue detenido en Liquiñe, cuando se dirigía a su domicilio
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/lagos-torres-luis-armando" target="_blank">Luis Armando Lagos Torres</a>, 50 años, obrero maderero del COFOMAP, militante del Partido Socialista, detenido en Carranco
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/reinante-raipan-alberto-segundo" target="_blank">Alberto Segundo Reinante Raipán</a>, 39 años, obrero maderero del COFOMAP, miembro del MCR, detenido en Trafún
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/reinante-raipan-ernesto" target="_blank">Ernesto Reinante Raipán</a>, 29 años, obrero maderero del COFOMAP, miembro del MCR, detenido en Trafún
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/reinante-raipan-modesto-juan" target="_blank">Modesto Juan Reinante Raipán</a>, 18 años, oberero maderero del COFOMAP, miembro del MCR, detenido en Trafún
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/rivera-catricheo-luis-alfredo" target="_blank">Luis Alfredo Rivera Catricheo</a>, cuya identidad se acreditó por medio de tesitgos, 54 años, obrero maderero del COFOMAP, sin militancia politica, detenido en Paimún
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/tracanao-pincheira-alejandro-antonio" target="_blank">Alejandro Antonio Tracanao Pincheira</a>, 22 años, obrero maderero del COFOMAP, vinculado al MCR, detenido en Trafún
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/tracanao-pincheira-miguel-jose" target="_blank">Miguel José Tracanao Pincheira</a>, 25 años, obrero maderero del COFOMAP, vinculado al MCR, detenido en Trafún
<br>  <br>  <a href="https://memoriaviva.com/detenidos-desaparecidos/tracanao-pincheira-eliseo-maximiliano" target="_blank">Eliseo Maximiliano Tracanao Valenzuela </a>, 18 años, obrero maderero del COFOMAP, vinculado al MCR, detenido en Trafún
<br><br>
...
// para que empieze con el marcador actual
filtrarMarcadores(anioActual);